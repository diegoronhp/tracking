<?php
	/*$owner_email='administrativa@trackingvip.co';*/
    $owner_email='soporte@trackingvip.co'; //se modifica la cuenta de correo de destino
    ...
    $subject='Un mensaje desde su pagina web';
    $user_email='';    
	$message_body='';
	$message_type='html';
