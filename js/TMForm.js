...
/*							modal.find('.modal-title').text('Success!')
                            ...
                            //Cambio del mensaje de notificacion de envio del correo mediante la respuesta del formulario de contacto
                            modal.find('.modal-title').text('Mensaje enviado!')
                            modal.find('.modal-body').text('Hemos recibido su mensaje y se atenderá su solicitud en el menor tiempo posible')
