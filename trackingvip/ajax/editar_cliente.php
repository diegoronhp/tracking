<?php
	...
	if (empty($_POST['mod_id'])) {
		...
		$sql="UPDATE clientes SET nit='".$nit."', dv='".$dv."', nombre='".$nombre."', telefono='".$telefono."', correo='".$email."', direccion='".$direccion."', ciudad='".$ciudad."', dia_corte='".$corte."', estado='".$estado."' WHERE id_cliente='".$id_cliente."'";
