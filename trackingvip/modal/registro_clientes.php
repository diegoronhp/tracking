		  ...
		  <div class="modal-body">
			...
			<div id="resultados_ajax"></div>
			  ...
			  <div class="form-group">
				<label for="dv" class="col-sm-3 control-label">DV</label>
				<div class="col-sm-3">
			  ...
			  <div class="form-group">
				<label for="dia_corte" class="col-sm-3 control-label">Dia Corte</label>
				<div class="col-sm-3">
					<input type="text" class="form-control" id="dia_corte" name="dia_corte"   >		  
				  </div>				  
				</div>
