...
<table width="500" border="0" style="table-layout:fixed";>
  ...
  <!--    <td width="45" height="52"></td> -->
      ...
      <td colspan="5" max-width="450" valign="bottom" align="right"></td>
    </tr>   
    ...
    <tr>
     ...
     <!-- <td height="25" valign="top">&nbsp;</td> -->
	  ...
	  <tr>
      <td>&nbsp;</td>
     <td colspan="5" height="290" valign="top">
...
$codigoHTML.='</td>
    ...
    <tr>
      <td colspan="4" align="center"><div style="font-size: 8;"><br>NUEVA DIRECCION: CARRERA 50 No. 1 G - 10 BARRIO JAZMIN<br><br></div></td>
      <td>&nbsp;</td>
      <td>&nbsp;</td>
    </tr>
    <tr>
