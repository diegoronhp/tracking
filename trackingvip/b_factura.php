	...
	<div class="panel panel-info">
		<div class="panel-heading">
		    <div class="btn-group pull-right">
	        	...
	        	<a href="consultafactura.php" class="btn btn-default" title='Cancelar' ><i> CANCELAR </i></a>	        
			...
			<h4><i class='glyphicon glyphicon-search'></i> Nueva <?php echo $concepto; ?> - Asignar Factura</h4>
		</div>
		<div class="panel-body">
			<form class="form-horizontal" role="form" id="dato">
						<div class="form-group row">
							...
							<div class="col-md-5">
								<input type="text" class="form-control" id="q" placeholder="Numero de factura" onkeyup='load(1);'>
							</div>
							<div class="col-md-3">
...
<script type="text/javascript" src="js/busca_factura.js"></script><!-- MUESTRA RESULTADOS -->
